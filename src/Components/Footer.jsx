    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-section contact">
          ...
          <p><i className="far fa-envelope"></i> <a href="mailto:crafty23jay@gmail.com">crafty23jay@gmail.com</a></p>
        </div>
        ...
        <div className="footer-section social">
          ...
          <div className="social-icons">
            ...
            <a href="mailto:crafty23jay@gmail.com" target="_blank" rel="noreferrer"><i className="far fa-envelope"></i></a>
